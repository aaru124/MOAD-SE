...
class DemoValues {
  //CollectionReference feed_user = FirebaseFirestore.instance.collection('feed-user');
  ...
  static final List<String> feed_users = [
    ...
    /*UserModel(
      ...
      image: "assets/images/Selection_033.png",
      followers: 123,
...
Repudiandae sint soluta ullam sunt eos id laborum. Veniam molestiae ipsa odit soluta in rerum amet. Deserunt rerum vero est eaque voluptas aspernatur ut voluptatem. Sint sed enim.""";
  ...
  static final List<String> posts = [
    ...
    /*PostModel(
      ...
      imageURL: "assets/images/Selection_030.png",
