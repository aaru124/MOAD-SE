          ...
          child: Column(
            ...
            children: [
             Container(
                  height: 100,
                decoration:
                    BoxDecoration(border: Border.all(color: Colors.blueAccent),color: Color.fromARGB(255, 29, 3, 34)),
               
                
                child:  Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children:[
                    Text("Your ECC Points: ",style: TextStyle(color: Colors.white,fontSize: 30),),
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    Map<String,dynamic> data = _data[index].data() as Map<String, dynamic>;
                    return Container(
