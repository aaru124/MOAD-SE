...
class _SubjectOneState extends State<SubjectFive> {
  ...
  void _totalCounter() async {
    ...
    setState(() {
      ...
      prefs.setDouble('${user}countertotal5', _countertotal);
    });
  }
  ...
  void _incrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterattend = ((prefs.getInt('${user}counterattend5') ?? 0) + 1);
      prefs.setInt('${user}counterattend5', _counterattend);
    });
  }
  ...
  void _decrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterabsent = ((prefs.getInt('${user}counterabsent5') ?? 0) + 1);
      prefs.setInt('${user}counterabsent5', _counterabsent);
    });
  }
