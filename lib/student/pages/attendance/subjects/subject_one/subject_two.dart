...
class _SubjectOneState extends State<SubjectTwo> {
  ...
  void _totalCounter() async {
    ...
    setState(() {
      ...
      prefs.setDouble('${user}countertotal2', _countertotal);
    });
  }
  ...
  void _incrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterattend = ((prefs.getInt('${user}counterattend2') ?? 0) + 1);
      prefs.setInt('${user}counterattend2', _counterattend);
    });
  }
  ...
  void _decrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterabsent = ((prefs.getInt('${user}counterabsent2') ?? 0) + 1);
      prefs.setInt('${user}counterabsent2', _counterabsent);
    });
  }
  ...
  void loadCounter() async {
    ...
    setState(() {
      _counterattend = (prefs1.getInt('${user}counterattend2') ?? 0);
      _counterabsent = (prefs2.getInt('${user}counterabsent2') ?? 0);
      _countertotal = (prefs3.getDouble('${user}countertotal2r') ?? 0);
      missed = (prefs3.getInt('${user}missed2') ?? 0);
    });
  }
  ...
  void calculateMissing() async {
    ...
    setState(() {
      missed = calc;
      prefs.setInt("'${user}missed2", missed);
    });
  }
