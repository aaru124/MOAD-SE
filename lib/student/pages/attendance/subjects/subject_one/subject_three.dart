...
class _SubjectOneState extends State<SubjectThree> {
  ...
  void _totalCounter() async {
    ...
    setState(() {
      ...
      prefs.setDouble('${user}countertotal3', _countertotal);
    });
  }
  ...
  void _incrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterattend = ((prefs.getInt('${user}counterattend3') ?? 0) + 1);
      prefs.setInt('${user}counterattend3', _counterattend);
    });
  }
  ...
  void _decrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterabsent = ((prefs.getInt('${user}counterabsent3') ?? 0) + 1);
  ...
  void loadCounter() async {
    ...
    setState(() {
      _counterattend = (prefs1.getInt('${user}counterattend3') ?? 0);
      _counterabsent = (prefs2.getInt('${user}counterabsent3') ?? 0);
      missed = (prefs2.getInt('${user}missed3') ?? 0);
      _countertotal = (prefs3.getDouble('${user}countertotal3') ?? 0);
    });
  }
  ...
  void calculateMissing() async {
    ...
    setState(() {
      missed = calc;
      prefs.setInt('${user}missed3', missed);
    });
  }
