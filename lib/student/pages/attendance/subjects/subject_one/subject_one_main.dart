...
class _SubjectOneState extends State<SubjectOne> {
  ...
  void _totalCounter() async {
    ...
    setState(() {
      ...
      prefs.setDouble('countertotal', _countertotal);
  ...
  void _incrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterattend = ((prefs.getInt('counterattend') ?? 0) + 1);
      prefs.setInt('counterattend', _counterattend);
    });
  }
  ...
  void _decrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterabsent = ((prefs.getInt('counterabsent') ?? 0) + 1);
      prefs.setInt('counterabsent', _counterabsent);
    });
  }
  ...
  void loadCounter() async {
    ...
    setState(() {
      _counterattend = (prefs1.getInt('counterattend') ?? 0);
      _counterabsent = (prefs2.getInt('counterabsent') ?? 0);
      _countertotal = (prefs3.getDouble('countertotal') ?? 0);
    });
  }
