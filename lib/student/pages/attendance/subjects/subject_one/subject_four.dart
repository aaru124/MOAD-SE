...
class _SubjectOneState extends State<SubjectFour> {
  ...
  void _totalCounter() async {
    ...
    setState(() {
      ...
      prefs.setDouble('countertotal4', _countertotal);
  ...
  void _incrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterattend = ((prefs.getInt('counterattend4') ?? 0) + 1);
      prefs.setInt('counterattend4', _counterattend);
    });
  }
  ...
  void _decrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterabsent = ((prefs.getInt('counterabsent4') ?? 0) + 1);
      prefs.setInt('counterabsent4', _counterabsent);
    });
  }
  ...
  void loadCounter() async {
    ...
    setState(() {
      _counterattend = (prefs1.getInt('counterattend4') ?? 0);
      _counterabsent = (prefs2.getInt('counterabsent4') ?? 0);
      _countertotal = (prefs3.getDouble('countertotal4') ?? 0);
    });
  }
