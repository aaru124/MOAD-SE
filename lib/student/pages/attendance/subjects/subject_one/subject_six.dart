...
class _SubjectOneState extends State<SubjectSix> {
  ...
  void _totalCounter() async {
    ...
    setState(() {
      ...
      prefs.setDouble('${user}countertotal6', _countertotal);
    });
  }
  ...
  void _incrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterattend = ((prefs.getInt('${user}counterattend6') ?? 0) + 1);
      prefs.setInt('${user}counterattend6', _counterattend);
    });
  }
  ...
  void _decrementCounter() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      _counterabsent = ((prefs.getInt('${user}counterabsent6') ?? 0) + 1);
      prefs.setInt('${user}counterabsent6', _counterabsent);
    });
  }
  ...
  void _decrementCounterundo() async {
    ...
    setState(() {
      _counterabsent = ((prefs.getInt('${user}counterabsent6') ?? 0) - 1);
      prefs.setInt('${user}counterabsent3', _counterabsent);
    });
  }
  ...
  void loadCounter() async {
    ...
    setState(() {
      _counterattend = (prefs1.getInt('${user}counterattend6') ?? 0);
      _counterabsent = (prefs2.getInt('${user}counterabsent6') ?? 0);
      _countertotal = (prefs3.getDouble('${user}countertotal6') ?? 0);
      missed = (prefs3.getInt('${user}missed6') ?? 0);
    });
  }
  ...
  void calculateMissing() async {
    ...
    setState(() {
      missed = calc;
      prefs.setInt('${user}missed6', missed);
    });
  }
