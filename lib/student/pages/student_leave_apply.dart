...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  CollectionReference students = FirebaseFirestore.instance.collection('leave-application');
...
Future<void> addApp(String fullName,String uid,String? yr,String? course,String email,String l_from,String l_till,String? img) {
              ...
              return null;
                ...
                Row(
                  ...
                  if(pickedDate != null ){
                      ...
                      setState(() {
                         l_from.text = formattedDate; //set output date to TextField value. 
                      });
                  }else{
                  ...
                  if(pickedDate != null ){
                      ...
                      setState(() {
                         l_till.text = formattedDate; //set output date to TextField value. 
                      });
                  }else{
                      print("Date is not selected");
                  }
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                if (_formKey.currentState!.validate()) {
                  addApp(name.text,uid.text,chosenValue,chosenValue1,email.text,l_from.text,l_till.text,image?.path);
