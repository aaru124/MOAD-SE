...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  CollectionReference students = FirebaseFirestore.instance.collection('train-concession');
...
Future<void> addApp(String fullName,String uid,String? yr,String? course,String l_from,String l_till,String ph_no,String addr,String? zone,String? travel_class,String? img) {
          ...
          Container(
            ...
            child: Text(
                  ...
                  if(pickedDate != null ){
                      ...
                      setState(() {
                         till.text = formattedDate; //set output date to TextField value. 
                      });
                  }else{
                      print("Date is not selected");
                  }
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                if (_formKey.currentState!.validate()) {
                  addApp(name.text,uid.text,chosenValue,chosenValue1,from.text,till.text,ph_no.text,address.text,chosenValue2,chosenValue3,image?.path);
